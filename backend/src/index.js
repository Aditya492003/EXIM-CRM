...
// Universal CORS & Preflight handler (Must be the very first middleware)
...
// Ensure DB connection is active for each non-OPTIONS request (vital for serverless cold starts)
